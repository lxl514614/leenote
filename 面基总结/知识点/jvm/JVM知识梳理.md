...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyE0icAGNPaEteKKHbuVVpIPBOlU7ckIGLNEmIuXGvWaRbFjpadDcF4VQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
`Java`堆中划分出一块内存来作为句柄池，引用中存储对象的句柄地址，而句柄中包含了对象实例数据与对象类型数据各自的具体地址信息，具体构造如下图所示：![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyHRog9oHptka36vgOlLibXqP4Wjb01liaQOhynEyscicIaydsKW1MOeb4Q/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyOjPnHBiccJy06Lx5yjDNlm0CHqQNq8ezkLzgI6IMpdt4AuOoNU3PIHQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyZ73twseL0ARZ3EwG3DKYmaXooJ4QB5cWGdkibyLrH8Y6FgfiakwTA9Tg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEysAkwCrbRobTCTrBt1KgRx9ImkKv8CnYXeG0bTfe754Vd7u9jBMoXkw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyaFkRf9WSxGf2Up74Mpc9OC6lujPyV2mIDCg8C0Yjw0L1m3YEgcSh1w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyS22twjkZOSkHCcTPCYKfW81icRwbLRoT2JCic2rcf7dTaL1N1riadZvfQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

### 说一下 JVM 有哪些垃圾回收器？

如果说垃圾收集算法是内存回收的方法论，那么垃圾收集器就是内存回收的具体实现。下图展示了7种作用于不同分代的收集器，其中用于回收新生代的收集器包括Serial、PraNew、Parallel Scavenge，回收老年代的收集器包括Serial Old、Parallel Old、CMS，还有用于回收整个Java堆的G1收集器。不同收集器之间的连线表示它们可以搭配使用。

![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEySuJK4KTV2YXoKt2O1OPhribGuEH2dTCMaWArR43KCWZ4IscM9fjEcQQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE11cL7gll9hJdrrM5uDDDEyVxarUF1sfGSpibPy2ZicgBFicSx78jYMbajAX0iadz7JBXFBcnmnT9XfqQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
